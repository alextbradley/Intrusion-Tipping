function [x,t_out, h_out, h1_out, u1_out, Fr_out, melt_out, dhdx_out, dhdt_out,idxmax] = evolve_shape(Fr_infty, C, S, lambda, N, M, dt, t_end, idx_out, t_plot)
...
% lambda    :   (scalar) dimensionless ice velocity lambda = (u_ice * Cd * L) / (u_infty * St * tau * c)
...
% idxmax    :    integer       : highest index which is touches
