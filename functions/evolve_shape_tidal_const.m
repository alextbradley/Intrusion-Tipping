function [x,t_out, h_out, h1_out, u1_out, Fr_out, melt_out, dhdx_out, dhdt_out,idxmax] = evolve_shape_tidal_const(Fr_infty, C, S, lambda,u_tidal,timescale, N, M, dt, t_end, idx_out, t_plot)
